...
static const char *fonts[]          = { "monospace:size=8" , "Tamsynmod:size=10"};
...
const char *spcmd1[] = {"alacritty", "--title", "spterm", "-d", "120 34", NULL };
const char *spcmd2[] = {"alacritty", "--title", "spcalc", "-d", "50 20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ NULL,      "spterm",    "spterm",      SPTAG(0),	  1,           1,         0,        -1 },
	{ NULL,      "spcalc",    "spcalc",      SPTAG(1),        1,           1,         0,        -1 },
};
...
static Key keys[] = {
	...
	{ ShiftMask,			XK_space,	spawn,		SHCMD("rofi -show run") },
	...
	//{ MODKEY|ShiftMask,		XK_Return,	togglescratch,	{.v = spcmd1 } },
	...
	{ 0,				XK_Print,	spawn,		SHCMD("maim -s screenshot-selection-$(date '+%y%m%d-%H%M-%S').png") },
